...
function validateVerifyCode(){
	...
	if(!verifyCode){
		...
		$.ajax({
			...
			type:"POST",
			dataType:"json",
			data:{method:"validateVerifyCode",verifyCode:verifyCode},
			url:"/majupublish/UserServlet",
 ...
 */
function _hyz(){
	$("#imgVerifyCode").attr("src","/majupublish/VerifyCodeServlet?a="+new Date().getTime());
}
