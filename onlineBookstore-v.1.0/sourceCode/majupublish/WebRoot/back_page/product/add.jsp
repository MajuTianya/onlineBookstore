...
<div class="body-box" style="float:right">
	<form id="jvForm" action="<c:url value='/admin/AdminBookServlet?method=add'/>" method="post" enctype="multipart/form-data">
			...
			<tbody id="tab_1">
				...
				<tr>
					...
					<td width="80%" class="pn-fcontent">
						...
						<input type="file" onchange="uploadPicture(7)" name="imageb" id="image_b"/>
					</td>
				</tr>
				<tr>
					<td width="20%" class="pn-flabel pn-flabel-h">
					...
					<td width="80%" class="pn-fcontent">
						...
						<input type="file" onchange="uploadPicture(9)" name="imagew" id="imagew"/>
					</td>
				</tr>
			</tbody>
