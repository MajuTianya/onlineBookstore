...
<%@ include file="/back_page/date.jsp" %>
     <ul class="w-lful">
		<li><a href="<c:url value='/admin/AdminBookServlet?method=findAll'/>" target="rightFrame">商品管理</a></li>
		<li><a href="<c:url value='/admin/AdminCategoryServlet?method=findAll'/>" target="rightFrame">分类管理</a></li>
     </ul>
</div>
</body>
</html>